...
#load data
world_cup=pd.read_csv('C:/Users/lenovo/Downloads/FIFA-2018-World-cup-predictions-master/datasets/world cup 2018 Dataset.csv')
results=pd.read_csv('C:/Users/lenovo/Downloads/FIFA-2018-World-cup-predictions-master/datasets/results.csv')
world_cup.head()
results.head()
...
ranking = pd.read_csv('C:/Users/lenovo/Downloads/FIFA-2018-World-cup-predictions-master/datasets/fifa_rankings.csv') 
fixtures = pd.read_csv('C:/Users/lenovo/Downloads/FIFA-2018-World-cup-predictions-master/fifa_world_cup_2018_RussianStandardTime.csv')
